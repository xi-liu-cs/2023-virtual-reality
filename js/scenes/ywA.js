...
export const init = async model =>
{
    ...
    let gltf3 = new Gltf2Node({url: './media/gltf/sponza/Sponza.gltf'});
    ...
    gltf0.scale = [.01,.01,.01];

    gltf1.translation = [20, 0, -20];
    gltf1.scale = [1,1,1];

    gltf2.translation = [-20, 20, 10];
    gltf2.scale = [10,10,10];

    gltf3.translation = [0, -10, 10];
    gltf3.scale = [1,1,1];
    let rotation3 = quat.create();
